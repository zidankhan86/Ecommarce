                        ...
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a rel="nofollow" href="{{url('/backend/https://templatemo.com/page/4')}}" target="_blank">Template Page 4</a></li>
                                </ul>
                            </li>
                ...
                <div class="col-lg-6">
                    <div class="left-content">
                        <div class="thumb">
                            ...
                            <img src="{{url('/frontend/assets/images/left-banner-image.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{url('/frontend/assets/images/baner-right-image-01.jpg')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{url('/frontend/assets/images/baner-right-image-02.jpg')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{url('/frontend/assets/images/baner-right-image-03.jpg')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{url('/frontend/assets/images/baner-right-image-04.jpg')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="first-item">
                        <div class="logo">
                            <img src="{{url('/frontend/assets/images/white-logo.png" alt="hexashop ecommerce templatemo')}}">
                        </div>
                        <ul>
